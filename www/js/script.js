...
/*	alert(maplongitude)*/
	...
	function initialize() {
      ...
      '<div id="siteNotice">'+
      '</div>'+
      '<h1 id="firstHeading" class="firstHeading">Recorrer los alrededores</h1>'+
      '<div id="bodyContent">'+
      '<p>Visualice las avenidas, calles, sitios y cercanías de este <b>proyecto</b></p>'+
      '<a class="button round tiny" href="#" onclick="mostrarProyectoStreet(&apos;{d:RowKey}&apos;, &apos;{d:latitud}&apos;, &apos;{d:longitud}&apos;);return false;">Vista 360°</a>'+
      '</div>'+
      '</div>';
